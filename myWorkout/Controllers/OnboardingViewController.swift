...
class OnboardingViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        collectionView.register(OnboardingCollectionViewCell.self, forCellWithReuseIdentifier: String(describing: OnboardingCollectionViewCell.self))
        ...
        let thirdScreen = OnboardingStruct(topLabel: "Have nice body",
                                           bottomLabel: "Bad body shape, poor sleep, lack of strength, weight gain, weak bones, easily traumatised body, depressed, stressed, poor metabolism, poor resistance",
                                           image: imageThird)
